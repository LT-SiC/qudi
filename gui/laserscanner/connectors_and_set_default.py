class initialize_connections_and_defaultvalue:
    def initialize_connections_and_defaultvalues(self):
        ...
        self._mw.ple_PulsedCTL_CheckBox.stateChanged.connect(self._voltscan_logic.ple_PulsedCTL_CheckBox_StateChanged)
        self._mw.ple_PulsedBlue_CheckBox.stateChanged.connect(self._voltscan_logic.ple_PulsedBlue_CheckBox_StateChanged)
        ...
        # self._mw.ple_CTLWhenIonized_CheckBox.stateChanged.connect(self._voltscan_logic.ple_CTLWhenIonized_CheckBox_StateChanged)
        ...
        self._mw.factor_V_to_GHz_pushButton.clicked.connect(self._voltscan_logic.factor_V_to_GHz_pushButton_Clicked)
        ...
        self._mw.ple_CTLDuration_LineEdit.textEdited.connect(self._voltscan_logic.ple_CTLDuration_LineEdit_textEdited)
        self._mw.ple_BlueDuration_LineEdit.textEdited.connect(self._voltscan_logic.ple_BlueDuration_LineEdit_textEdited)
        ...
        #self._mw.ple_CTLDecay_LineEdit.textEdited.connect(self._voltscan_logic.ple_CTLDecay_LineEdit_textEdited)
        ...
        self._mw.ple_CWCTL_CheckBox.stateChanged.connect(self._voltscan_logic.ple_CWCTL_CheckBox_StateChanged)
        self._mw.ple_CWBlue_CheckBox.stateChanged.connect(self._voltscan_logic.ple_CWBlue_CheckBox_StateChanged)
        ...
        self._mw.factor_V_to_GHz_LineEdit.textEdited.connect(self._voltscan_logic.factor_V_to_GHz_LineEdit_textEdited)
        ...
        self._mw.ple_CWCTL_CheckBox.setChecked(self._voltscan_logic.enable_CTL)
        self._mw.ple_CWBlue_CheckBox.setChecked(self._voltscan_logic.enable_Blue)
        self._mw.ple_PulsedRepump_CheckBox.setChecked(self._voltscan_logic.enable_PulsedRepump)
        self._mw.ple_PulsedCTL_CheckBox.setChecked(self._voltscan_logic.enable_PulsedCTL)
        self._mw.ple_RepumpWhenIonized_CheckBox.setChecked(self._voltscan_logic.RepumpWhenIonized)
        # self._mw.ple_CTLWhenIonized_CheckBox.setChecked(self._voltscan_logic.CTLWhenIonized)
        ...
        self._mw.ple_CTLDuration_LineEdit.setText(str(self._voltscan_logic.CTLDuration))
        self._mw.ple_BlueDuration_LineEdit.setText(str(self._voltscan_logic.BlueDuration))
        #self._mw.ple_RepumpDecay_LineEdit.setText(str(self._voltscan_logic.RepumpDecay))
        #self._mw.ple_CTLDecay_LineEdit.setText(str(self._voltscan_logic.CTLDecay))
        ...
        self._mw.factor_V_to_GHz_LineEdit.setText(str(self._voltscan_logic.factor_V_to_GHz))
    ...
    def disconnect_all(self):
        ...
        self._mw.ple_PulsedCTL_CheckBox.stateChanged.disconnect()
        self._mw.ple_RepumpWhenIonized_CheckBox.stateChanged.disconnect()
        # self._mw.ple_CTLWhenIonized_CheckBox.stateChanged.disconnect()
        ...
        self._mw.factor_V_to_GHz_pushButton.clicked.disconnect()
        ...
        self._mw.ple_CTLDuration_LineEdit.textEdited.disconnect()
        self._mw.ple_BlueDuration_LineEdit.textEdited.disconnect()
        ...
        #self._mw.ple_CTLDecay_LineEdit.textEdited.disconnect()
        ...
        self._mw.ple_CWCTL_CheckBox.stateChanged.disconnect()
        self._mw.ple_CWBlue_CheckBox.stateChanged.disconnect()
        self._mw.ple_PerformFit_CheckBox.stateChanged.disconnect()
        self._mw.ple_Stoptime_LineEdit.textEdited.disconnect()
        self._mw.factor_V_to_GHz_LineEdit.textEdited.disconnect()
