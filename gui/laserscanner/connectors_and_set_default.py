class initialize_connections_and_defaultvalue:
    def initialize_connections_and_defaultvalues(self):
        ...
        self._mw.ple_PulsedGreen_CheckBox.stateChanged.connect(self._voltscan_logic.ple_PulsedGreen_CheckBox_StateChanged)
        ...
        # self._mw.ple_GreenWhenIonized_CheckBox.stateChanged.connect(self._voltscan_logic.ple_GreenWhenIonized_CheckBox_StateChanged)
        ...
        self._mw.ple_GreenDuration_LineEdit.textEdited.connect(self._voltscan_logic.ple_GreenDuration_LineEdit_textEdited)
        ...
        #self._mw.ple_GreenDecay_LineEdit.textEdited.connect(self._voltscan_logic.ple_GreenDecay_LineEdit_textEdited)
        ...
        self._mw.ple_CWGreen_CheckBox.stateChanged.connect(self._voltscan_logic.ple_CWGreen_CheckBox_StateChanged)
        ...
        self._mw.ple_CWGreen_CheckBox.setChecked(self._voltscan_logic.enable_Green)
        self._mw.ple_PulsedRepump_CheckBox.setChecked(self._voltscan_logic.enable_PulsedRepump)
        self._mw.ple_PulsedGreen_CheckBox.setChecked(self._voltscan_logic.enable_PulsedGreen)
        self._mw.ple_RepumpWhenIonized_CheckBox.setChecked(self._voltscan_logic.RepumpWhenIonized)
        # self._mw.ple_GreenWhenIonized_CheckBox.setChecked(self._voltscan_logic.GreenWhenIonized)
        ...
        self._mw.ple_GreenDuration_LineEdit.setText(str(self._voltscan_logic.GreenDuration))
        #self._mw.ple_RepumpDecay_LineEdit.setText(str(self._voltscan_logic.RepumpDecay))
        #self._mw.ple_GreenDecay_LineEdit.setText(str(self._voltscan_logic.GreenDecay))
    ...
    def disconnect_all(self):
        ...
        self._mw.ple_PulsedGreen_CheckBox.stateChanged.disconnect()
        self._mw.ple_RepumpWhenIonized_CheckBox.stateChanged.disconnect()
        # self._mw.ple_GreenWhenIonized_CheckBox.stateChanged.disconnect()
        ...
        self._mw.ple_GreenDuration_LineEdit.textEdited.disconnect()
        ...
        #self._mw.ple_GreenDecay_LineEdit.textEdited.disconnect()
        ...
        self._mw.ple_CWGreen_CheckBox.stateChanged.disconnect()
